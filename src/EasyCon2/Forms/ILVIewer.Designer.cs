namespace EasyCon2.Forms
{
    partial class ILVIewer
    {
        ...
        private void InitializeComponent()
        {
            ...
            Controls.Add(searchYNUD);
            Controls.Add(searchXNUD);
            Controls.Add(targetHNUD);
            Controls.Add(targetWNUD);
            Controls.Add(targetYNUD);
            Controls.Add(targetXNUD);
            Controls.Add(imgLabelNametxt);
            Controls.Add(imgnamelabel);
        ...
        private TextBox imgLabelNametxt;
