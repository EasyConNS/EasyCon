...
internal static class BoundFactory
{
    ...
    public static BoundNop Nop(Statement syntax)
    {
    ...
    private static BoundBinaryExpression Binary(ExprBase syntax, BoundExpr left, BoundBinaryOperator op, BoundExpr right)
    {
