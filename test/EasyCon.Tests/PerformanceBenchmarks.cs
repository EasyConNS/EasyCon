...
public class PerformanceBenchmarks
{
    ...
    private static (double Ms, string[] Output) RunScript(string code)
    {
        ...
        for (int i = 0; i < WarmupIterations; i++)
        {
            ...
            compilation.Evaluate(new MockOutputAdapter(), null, null, null, null, null, warmupCts.Token);
        }
        ...
        var result = compilation.Evaluate(output, null, null, null, null, null, cts.Token);
        sw.Stop();
