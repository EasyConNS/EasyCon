...
:: ========== 编译 EasyCon2.Avalonia ==========
set "PROJ_NAME=EasyCon2.Avalonia"
set "PROJ_DIR=%ROOT_DIR%\src\%PROJ_NAME%"
...
if exist "%PUBLISH_DIR%\EasyCon2.Avalonia.exe" ren "%PUBLISH_DIR%\EasyCon2.Avalonia.exe" "EasyCon2.Avalonia.!COMMIT_ID!.exe"
