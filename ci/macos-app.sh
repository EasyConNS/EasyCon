...
echo "========================================="
echo "  打包完成!"
echo "  应用: $DIST_DIR/publish/$APP_NAME.app"
echo "  CLI:  $DIST_DIR/publish/$APP_NAME.app/Contents/MacOS/ezcon"
echo "  绑定系统命令: sudo ln -sf /Applications/$APP_NAME.app/Contents/MacOS/ezcon /usr/local/bin/ezcon"
echo "========================================="
